...
<body>
    <main class="container">
        ...
        <section class="form">
            <form method="GET" action="bonus_movies.php">
        ...
        <section class="links">
            ...
            <a href="bonus_movies.php">Show all movies</a>
            &nbsp

            <!-- Add a link that will show only movies with a release date after 2000 -->
            <a href="bonus_movies.php?release=greaterthan2000">All movies released after 2000</a>
            &nbsp
            <!-- Add a link that shows all movies w/ the comedy genre -->
            <a href="bonus_movies.php?genre=comedy">Show only comedies</a>
            &nbsp
            <!-- Add a link that shows all movies w/ the sci-fi genre -->
            <a href="bonus_movies.php?genre=sci-fi">Show only Sci-Fi</a>
